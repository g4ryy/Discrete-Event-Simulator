...
class Main3 {
    public static void main(String[] args) {
        ...
        while (sc.hasNextDouble()) {
            ...
            ArrivalEvent arrEvent;

            if (greedy) {
                arrEvent = new ArrivalEvent(new GreedyCustomer(numOfCustomers, 
                        serviceTime, arrivalTime), arrivalTime);
            } else {
                arrEvent = new ArrivalEvent(new Customer(numOfCustomers, serviceTime, arrivalTime), 
                                                         arrivalTime);
            }
